...
var Translator = function (_PureComponent) {
    _inherits(Translator, _PureComponent);
    ...
    _createClass(Translator, [{
        ...
        value: function translate(transKey, locale, messageObj) {
            var msgObj = this.state.msgObj;

            var message = msgObj ? msgObj : messageObj;

            if (transKey && locale && message) this.setState({ translation: message[locale][transKey] });
        }
    }, {
        key: 'render',
